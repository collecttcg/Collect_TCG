...
export function register(appContext){
  ...
  function marketDemandHtml(markets,supported){
    if(supported===false){
      return `<div class="insights-v14-empty"><strong>Country × Card data is ready in the UI.</strong><br>Run <code>migrations/2026/2026-09-17-v05-COUNTRY-CARD-DEMAND.sql</code> in Supabase to enable this panel.</div>`;
    }
    if(!markets.length){
  ...
  function discoverySummaryHtml(){
    if(discoverySupported===false){
      return `<div class="insights-v14-empty">Discovery attribution is not available yet. Run <code>migrations/2026/2026-09-24-v06-DISCOVERY-SUMMARY.sql</code> after the Phase 2B1 migration.</div>`;
    }
